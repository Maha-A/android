...
//	private String url = "http://192.168.1.135:8888/DirectoryService/registertoDB.php";//home	
	private String url = "http://192.168.43.213:8888/DirectoryService/registertoDB.php";//tethring
	public void onCreate(Bundle savedInstanceState) {
        ...
        ok.setOnClickListener(new OnClickListener ()
        {
        			...
        			(Qdepartment.getText().toString().length()==0)|| QTitle.getText().toString().length()==0)
        	{
 			   ...
 			   Log.d("the data am sending to accessWebService",name+" "+lastname+" "+title+"* ");
	...
	private class JsonReadTask extends AsyncTask<String, Void, String> 
	{
		  ...
		  protected String doInBackground(String... params) 
		  {
		   ...
		   try {
			   ...
			   Log.d("the data am sending to server",name+" "+lastname+" "+title+" ");
	...
	if(!check)
	{
		...
		Toast.makeText(getApplicationContext(),
		 ...
		 Log.d("check","is true");
		 check=false;
		 Log.d("jsonResult is",jsonResult);
